...
class IdTokenResultMock implements IdTokenResult {
    token: string;
    claims: { [key: string]: any; };
    signInProvider: string;
    expirationTime: number;
...
class GetRemoteConfigResultMock implements GetRemoteConfigResult {
    /**
     * The date the data was last refreshed from the server.
     * Should honor the 'cacheExpirationSeconds' you passed in previously.
     */
...
export namespace firestore {
    ...
    class QueryMock implements Query {
        get(options?: GetOptions): Promise<QuerySnapshot> {
            return Promise.resolve(
    ...
    class CollectionReferenceMock extends QueryMock implements CollectionReference {
        id = '';
        parent = null;
        doc(documentPath?: string): firestore.DocumentReference {
            return new DocumentReferenceMock()
        };
        add(data: firestore.DocumentData): Promise<firestore.DocumentReference> {
            return Promise.resolve(
                new DocumentReferenceMock()
            )
        };
    }
    ...
    class WriteBatchMock implements WriteBatch {
        set(documentRef: DocumentReference, data: DocumentData, options?: SetOptions): WriteBatch {
            return this
        }
    ...
    function collection(collectionPath: string): CollectionReference {
        return new CollectionReferenceMock()
    }
